...
public final class ObjectDef {
	 ...
	 */
	private static final Logger LOGGER = Logger.getLogger(ObjectDef.class.getName());
	...
	public static ObjectDef forID(int i) {
		...
		// Start of custom or modified objects
		        ...
		        case 6282:
		        	class46.name = "Boss portal(MEMBERS ONLY)";
		        	break;
	...
	public static void dumpNames() {
		try {
			FileWriter fw = new FileWriter(System.getProperty("user.home")+"/Desktop/objectList 121.2 data.txt");
			for (int i = 0; i < totalObjects; i++) {
				...
				if (objectDefinition.name != null && !objectDefinition.name.equalsIgnoreCase("null")) {
					fw.write(objectDefinition.id + " - " + objectDefinition.name);
					fw.write(System.getProperty("line.separator"));
				} else if (objectDefinition.name == null) {
