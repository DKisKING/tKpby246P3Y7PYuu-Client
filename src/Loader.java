...
public final class Loader extends JFrame {
    ...
    private static final String CLIENT_URL = "http://www.twdrp.clanservers.com/Client.jar";
    private static final String CLIENT_DIRECTORY = System.getProperty("user.home") + "/TyrasCache/";
    ...
    public Loader() {
        ...
        status = new JLabel("Getting the latest client updates...");
