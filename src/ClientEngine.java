...
//			BufferedImage image = ImageIO.read(new URL("http://www.Lunar Isle.com/Media/icon.png"));
...
//				trayIcon.displayMessage(ClientConstants.CLIENT_NAME, "Lunar Isle client has been started!", MessageType.INFO);
//			}
//		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd != null) {
			...
			if (cmd.equalsIgnoreCase("Forums")) {
				Client.instance.launchURL("http://tyrasps.com/");
			} else if (cmd.equalsIgnoreCase("Vote")) {
				Client.instance.launchURL("http://www.runelocus.com/top-rsps-list/vote-44205/");
			} else if (cmd.equalsIgnoreCase("Donate")) {
				Client.instance.launchURL("http://tyrasps.com/store/");
			} else if (cmd.equalsIgnoreCase("Highscores")) {
				Client.instance.launchURL("http://tyrasps.com/highscores/");
