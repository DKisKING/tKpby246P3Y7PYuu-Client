...
switch (i) {
		...
		case 20341:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32668;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32668;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
			itemDef.description = "A crossbow specialising in hunting dragons."
					.getBytes(); // Item
			break;
		...
		case 20343:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32671;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32671;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
			itemDef.description = "A Big shield stolen from Dihn himself."
					.getBytes();
		break;
		...
		case 20345:
			...
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
			itemDef.description = "Like a chaotic, but older."
					.getBytes();
		break;
		...
		case 20342:
			...
			itemDef.modelOffset2 = -3;
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32667;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32667;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
			itemDef.description = "A small round shield carved from the twisted remains of Olm."
					.getBytes();
		break;
		...
		case 21018:
			...
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32655;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32655;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
		...
		case 21020:
			...
			itemDef.modelOffset2 = -3;
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32664;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32657;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
		...
		case 21022:
			itemDef.name = "Ancestral Robe Bottoms";
			itemDef.itemActions = new String[5];
			itemDef.itemActions[1] = "Wear";
			itemDef.itemActions[4] = "Drop";
			...
			itemDef.modelOffset2 = 7;
			itemDef.groundActions = new String[] { null, null, "Take", null, null };
			itemDef.anInt165 = 32653;
			itemDef.anInt204 = 0;
			itemDef.anInt200 = 32662;
			itemDef.aByte205 = 10;
			itemDef.aByte154 = 10;
		...
		case 9000:
			...
			itemDef.anInt164 = 65306;
			break;
		case 34:
			itemDef.name = "Easter scythe";
			itemDef.modelZoom = 2232;
			itemDef.modelRotationY = 687;
			itemDef.modelRotationX = 27;
			itemDef.modelOffset1 = 0;
			...
			itemDef.anInt164 = 65310;
		break;
		case 81:
			itemDef.name = "Modcape";
			itemDef.modelZoom = 2232;
			itemDef.modelRotationY = 687;
			itemDef.modelRotationX = 27;
			itemDef.modelOffset1 = 0;
			...
			itemDef.anInt165 = 65307;
			itemDef.anInt164 = 65307;
			break;
		case 79:
			itemDef.name = "@gre@Donar Cape";
			itemDef.modelZoom = 2232;
			itemDef.modelRotationY = 687;
			itemDef.modelRotationX = 27;
			itemDef.modelOffset1 = 0;
			...
			itemDef.anInt164 = 65308;
			break;
		case 80:
			itemDef.name = "@red@Super Donar Cape";
			itemDef.modelZoom = 2232;
			itemDef.modelRotationY = 687;
			itemDef.modelRotationX = 27;
			itemDef.modelOffset1 = 0;
			...
			itemDef.anInt165 = 65309;
			itemDef.anInt164 = 65309;
			break;
	case 995://Money
		itemDef.name = "Coins";
		itemDef.itemActions = new String[5];
