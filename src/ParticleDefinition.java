...
public class ParticleDefinition {
 ...
 new ParticleDefinition() { {
   //Owner/Admin Cape	(Gold Color)
        ...
        new ParticleDefinition() { {
            //easter Cape	(blue Color)
          setStartVelocity(new ParticleVector(0, -1, 0));
             setEndVelocity(new ParticleVector(0, -1, 0));
             setGravity(new ParticleVector(0, 2 / 4, 0));
             setLifeSpan(19);
             setStartColor(0x4FE6FF);
             setSpawnRate(4);
             setStartSize(1.25f);
             setEndSize(0);
             setStartAlpha(0.095f);
        ...
        new ParticleDefinition() { {
            //easter top color Cape	(yellow Color)
          setStartVelocity(new ParticleVector(0, -1, 0));
             setEndVelocity(new ParticleVector(0, -1, 0));
             setGravity(new ParticleVector(0, 2 / 4, 0));
             setLifeSpan(19);
             setStartColor(0xFFFF4E);
             setSpawnRate(4);
             setStartSize(1.25f);
             setEndSize(0);
             setStartAlpha(0.095f);
