...
public class CustomInterfaces extends RSInterface {
	...
	public static void unpackInterfaces(TextDrawingArea[] Vencillio) {
		...
		/*
		 * Handles teleporting to various locations around Lunar Isle
		 */
		...
		/*
		 * Handles the credits system for Lunar Isle
		 */
	...
	public static void reportAbuse(TextDrawingArea[] daniel) {
		...
		String[] rules = { 
			...
			"Tyras staff impersonation", "Account sharing/trading", "Macroing", "Multiple logging in",
	...
	public static void fireColor(TextDrawingArea[] vencillio) {
		...
		addText(49760, "Tyras Clan: Help", 0xff9933, true, true, -1, vencillio, 0);
	...
	public static void starter(TextDrawingArea[] daniel) {
		...
		addSprite(51751, 431);
		addText(51752, "Tyras Account Setup", 0xff9933, true, true, 52, daniel, 2);
	...
	public static void spawnTab(TextDrawingArea[] daniel) {
		...
		addSprite(61251, 82);
		addSprite(61252, 38);
		addText(61253, "Tyras Spawn Tab", daniel, 0, 0xF7AA25, true, true);
	...
	public static void loyaltyShop(TextDrawingArea[] tda) {
		...
		addText(id + 8, "Welcome to the Tyras title shop.", tda, 0, 0xe6be78, false, true);
	...
	public static void bankSettings(TextDrawingArea[] vencillio) {
		...
		addSprite(32501, 368);
		addText(32502, "Tyras Bank Settings", 0xff9933, true, true, -1, vencillio, 2);
	...
	public static void friendsTab(TextDrawingArea[] tda) {
		...
		addText(5070, "Tyras", tda, 0, 0xff9933, false, true);
	...
	public static void ignoreTab(TextDrawingArea[] tda) {
		...
		addText(5720, "Tyras", tda, 0, 0xff9933, false, true);
	...
	public static void mysteryBox(TextDrawingArea[] daniel) {
		...
		addHoverText(17011, "Purchase more credits", "Purchase Tyras credits", daniel, 0, 0xF7AA25, false, true, 168);
	...
	public static void creditsTab(TextDrawingArea[] daniel) {
		...
		addSprite(52501, 38);
		addText(52502, "Tyras Credits", 0xff9933, true, true, -1, daniel, 2);
		addSprite(52503, 55);
		addText(52504, "Current credits:", 0xff9933, true, true, -1, daniel, 0);
		addHoverText(52505, "Purchase more credits", "Purchase Tyras credits", daniel, 0, 0xF7AA25, true, true, 168);
		addSprite(52506, 56);
		tab.totalChildren(9);
	...
	public static void questTab(TextDrawingArea[] vencillio) {
		...
		addSprite(29401, 82);
		addSprite(29402, 38);
		addText(29403, "Tyras", vencillio, 2, 0xF7AA25, true, true);
		addText(29407, "", vencillio, 2, 0xF7AA25, true, true);
