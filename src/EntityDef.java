...
public final class EntityDef {
	...
	public static EntityDef forID(int i, boolean cached) {
		...
		case 3585:
			entityDef.name = "Effigy(Project Reality point shop)";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Trade";
			break;
		...
		case 3843:
			entityDef.name = "Project Reality Guide";
			break;
		...
		case 3844:
			entityDef.name = "Project Reality Guard(Security)";
			entityDef.actions = new String[5];
			entityDef.actions[0] = "Talk-to";
			break;
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		//Stream stream2 = new Stream(FileOperations.ReadFile(Signlink.findcachedir()+ "Config/npc.idx"));
		 //stream = new Stream(FileOperations.ReadFile(Signlink.findcachedir()+ "Config/npc.dat"));
